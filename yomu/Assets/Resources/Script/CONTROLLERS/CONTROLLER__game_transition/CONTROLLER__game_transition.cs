...
public class CONTROLLER__game_transition {

        //** relacionado com a parte visual

        public static CONTROLLER__game_transition instancia;
        public static CONTROLLER__game_transition Get_instance(){ return instancia; }
        ...
        public void Change_node( string _name, RESOURCE__structure_copy _content_structure ){
                ...
                Space_switcher switching_cameras_data = Controllers_program.canvas_spaces.Switch_cameras( _name );
