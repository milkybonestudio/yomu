...
public static class TOOL__resource_images_sequences_handler_DOWN {


        public static int Handle_waiting_to_destroy_current_resource( MANAGER__resources_images_sequences _manager, RESOURCE__image _image ){
        ...
        private static int Destroy_compress_low_quality_data( MANAGER__resources_images_sequences _manager, RESOURCE__image _image ){
        ...
        private static int Destroy_compress_data( MANAGER__resources_images_sequences _manager, RESOURCE__image _image ){
        ...
        private static int Destroy_resource_texture( MANAGER__resources_images_sequences _manager, RESOURCE__image _image ){
