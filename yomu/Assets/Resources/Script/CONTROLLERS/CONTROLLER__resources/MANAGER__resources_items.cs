...
public class MANAGER__resources_items : MANAGER__RESOURCES {

        
        public MANAGER__resources_items(){
        ...
        public RESOURCE__structure_copy Get_item( Resource_context _context, string _main_folder, string _path_local, Resource_structure_content _level_pre_allocation ){ return context_structures_modules[ ( int ) _context ].Get_structure_copy( _main_folder, _path_local, _level_pre_allocation ) ; }
