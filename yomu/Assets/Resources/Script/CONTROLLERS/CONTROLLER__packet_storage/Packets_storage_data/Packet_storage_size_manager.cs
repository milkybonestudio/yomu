...
unsafe public struct Packet_storage_size_manager {

    public static Packet_storage_size[] sizes_enum = (Packet_storage_size[]) Enum.GetValues( typeof(Packet_storage_size) );

    public fixed int sizes[ (int)Packet_storage_size.END ];
    ...
    public Packet_storage_size Get_required_size( int _size_in_bytes ){
        ...
        int index = Ceiling( ( int ) Packet_storage_size.END , _size_in_bytes );
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private int Ceiling( int _length, int _value ){
