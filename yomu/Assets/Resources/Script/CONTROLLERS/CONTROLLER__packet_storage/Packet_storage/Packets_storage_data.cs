...
unsafe public struct Packets_storage_data {
    ...
    public void Set_from_disk(){
        ...
        infos = (Packet_storage_info*)( storage_pointer->infos_buffer); 
    ...
    public Packet_storage_info* infos;
    ...
    private void Expand_file( int _need_bytes ){
        ...
        file_length = file_link.Get_heap_key().Get_length();
    ...
    public void Print_flags( Packet_storage_size _size ){ Safety(); infos[(int)_size].Print_flags( storage_pointer ); }
    public void Print_actives( Packet_storage_size _size ){ Safety(); infos[(int)_size].Print_actives( storage_pointer ); }
    public void Print_data( Packet_storage_size _size ){ Safety(); infos[(int)_size].Print_data( storage_pointer ); }
