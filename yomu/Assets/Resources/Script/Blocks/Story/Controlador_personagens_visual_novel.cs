            ...
            public void Mudar_foco_camera_personagens (  string  _modo, bool _eh_instantaneo ){
                    ...
                    IEnumerator a(  Vector3 _position,  float _valor_scale ){
                            ...
                            COROUTINE.Iniciar_coroutine_especifico_array( 
                                                                            _coroutine_array: foco_camera_personagens_coroutine_arr,
                                                                            _index: 1,
                                                                            IEn:   COROUTINE.Mudar_position_generico(tempo_ms , personagens_container.transform, _position ) 
                                                                        );
                            ...
                            COROUTINE.Iniciar_coroutine_especifico_array( 
                                                                            _coroutine_array: foco_camera_personagens_coroutine_arr,
                                                                            _index: 2,
                                                                            IEn:   COROUTINE.Mudar_scale_generico(tempo_ms , personagens_container.transform, _valor_scale )
                                                                        );
