...
public class Controlador_tela_story {
    ...
    public  Image[] Criar_frames(  int _numero_quadros, string _nome ="animacao", bool _tem_transicao = false){
                ...
                IEnumerator Trocar(){
                        ...
                        yield return COROUTINE.Transicionar_cor( cor_inicial, cor_final,  tempo,  animacao_images_arr );
        ...
        public void Transicao_cor_inicio ( int _tempo_ms ){
                ...
                IEnumerator a() {
                        ...
                        yield return  COROUTINE.Transicionar_cor(   Color.clear  , Color.black ,   tempo_ms_float , new Image[] { transicao_cor_image }  ) ;
//                        throw new ArgumentException("");
                        transicao_coroutine = null;
                        yield break;
        ...
        public void Transicao_cor_final ( int _tempo_ms ){
                ...
                IEnumerator a(){
                        ...
                        yield  return  COROUTINE.Transicionar_cor(   Color.black  , Color.clear ,   tempo_ms_float , new Image[] { transicao_cor_image }  ) ;
                        transicao_coroutine = null;
                        yield break;
                }
