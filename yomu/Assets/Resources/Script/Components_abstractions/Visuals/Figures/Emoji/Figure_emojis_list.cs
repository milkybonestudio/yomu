...
public class Figure_emojis_list {
    ...
    public static Figure_emoji_data Get( Figure_mode_emoji _emoji ){ return list._Get( _emoji ); }


    public Figure_emoji_data _Get( Figure_mode_emoji _emoji ){
    
        if( images == null )
            { images = Controllers.resources.images; }

        switch( _emoji ){

            case Figure_mode_emoji.heart : return Heart();
