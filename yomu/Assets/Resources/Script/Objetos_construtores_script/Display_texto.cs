...
public class _Display_texto {
    ...
    //     public         Coroutine                    texto_coroutine = null;
        ...
        public   _Display_texto( string _nome , float _width, float _height, float _font_size = 5f ) {
    ...
    //                     vertex_colors[ char_info.vertexIndex + 0 ].a = ( byte ) alphas[ i ];
