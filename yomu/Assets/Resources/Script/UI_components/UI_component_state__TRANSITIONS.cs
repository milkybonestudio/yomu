...
public struct UI_component_state__TRANSITIONS {

    public static UI_component_state__TRANSITIONS Construct(){

        UI_component_state__TRANSITIONS transitions = default;
