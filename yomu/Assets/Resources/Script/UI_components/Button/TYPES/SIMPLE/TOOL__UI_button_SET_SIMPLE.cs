...
public static class TOOL__UI_button_SET_SIMPLE {
        ...
        public static void SET_ON_static( UI_button_SIMPLE botao ){
                ...
                botao.estado_visual_botao = UI_button_SIMPLE_visual_state.on_estatico;
        ...
        public static void SET_OFF_static( UI_button_SIMPLE botao ){
                ...
                botao.estado_visual_botao = UI_button_SIMPLE_visual_state.off_estatico;
                botao.Update_parte_visual();
                     ...
                     if( botao.data.tipo_transicao == DEVICE_button_transition_type_OFF_ON.cor )
                        {
                            ...
                            botao.estado_visual_botao = UI_button_SIMPLE_visual_state.transicao_animacao_ON_para_OFF;
                     ...
                     if( botao.data.tipo_transicao == DEVICE_button_transition_type_OFF_ON.cor )
                        {
                            ...
                            botao.estado_visual_botao = UI_button_SIMPLE_visual_state.transicao_animacao_OFF_para_ON;
