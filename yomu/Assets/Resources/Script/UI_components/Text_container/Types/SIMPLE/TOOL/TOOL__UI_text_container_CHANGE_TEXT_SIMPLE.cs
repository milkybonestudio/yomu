...
public static class TOOL__UI_text_container_CHANGE_TEXT_SIMPLE {
        ...
        public static void Build( UI_text_container_SIMPLE _container, string _target_text ,string _pre_texto  ){
        ...
        public static void Update_writing( UI_text_container_SIMPLE _container ){
        ...
        public static void Force_complete( UI_text_container_SIMPLE _container ){
        ...
        public static void Build_instant( UI_text_container_SIMPLE _container, string _pre_text , string _target_text ){
        ...
        public static void Build_typewriter( UI_text_container_SIMPLE _container, string _pre_text , string _target_text){
        ...
        public static UI_text_container_writing_state Update_typewriter( UI_text_container_SIMPLE _container ){
        ...
        public static void Build_fade( UI_text_container_SIMPLE _container, string _pre_text , string _target_text ){
        ...
        public static UI_text_container_writing_state Update_fade( UI_text_container_SIMPLE _container ){
