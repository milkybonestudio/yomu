...
*/
    ...
    public static class SAINT_LAND__CATEDRAL__DORMITORIO_FEMININO_interativos_lista {
        ...
        public static Interativo Pegar_interativo( int _interativo_id_no_slot ){
            ...
            if( interativos[ _interativo_id_no_slot ] == null )
                { throw new Exception( $"nao foi achado o interativo{ (_interativo_id_no_slot + ( 0 * 100 )) } na lista 0" ); }

            return interativos[ _interativo_id_no_slot ];
