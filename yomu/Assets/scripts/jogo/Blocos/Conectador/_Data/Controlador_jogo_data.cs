...
public class Controlador_jogo_data{
    ...
    public void Iniciar(){
     ...
     public static Ponto Criar_ponto(  Ponto_nome _ponto_nome ){
        ...
        // public Interativo_nome[] Pegar_interativos_para_subtrair(  Ponto_nome _nome, Periodo_tempo _periodo_tempo , Interativo_nome[] _interativos , Tipo_get_interativo _tipo_get_interativo){


        //         int slot = Calcular_slot(  _periodo_tempo, _tipo_get_interativo );


        //         Controlador_dados_dinamicos.Pegar_instancia().lista_navegacao.Mudar_interativos_para_acrescentar(  

        //                 _ponto_nome: Ponto_nome.UP_quarto_nara,
        //                 _slot: slot, 
        //                 _interativos: _interativos
        ...
        // public int Calcular_slot(   Periodo_tempo _periodo_tempo , Tipo_get_interativo _tipo_get_interativo  ){

        //         if( _tipo_get_interativo == Tipo_get_interativo.dia_E_noite){

        //                 int periodo_tempo_int = (int) _periodo_tempo;

        //                 if( periodo_tempo_int < 3 ) return 0;

        //                 return 1;

        //         }

        //         if(  _tipo_get_interativo == Tipo_get_interativo.all  ){

        //                 return (int) _periodo_tempo;

        //         } 

        //         // Tipo_get_interativo.nao_altera
        //         return 0; 
