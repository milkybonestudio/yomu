...
//     public static IEnumerator Iniciar(  Chave_cache _chave, int _save, bool _novo_jogo ){
...
//         //     if ( jogo == null )
//         //         { throw new Exception("instancia de jogo estava vazia"); }
...
//         //             jogo.controlador_save = Controlador_save.Construir( _save, _novo_jogo );
//         //             jogo.controlador_AI = Controlador_AI.Construir();
