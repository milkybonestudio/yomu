...
public static class Finalizador_MINIGAMES {
        ...
        public static Assembly asm_finalizar__MINIGAMES__CONECTOR;
        ...
        public static void Finalizar_especifico( string[] _finalizar_localizador ){   
                ...
                ref Assembly asm_ref = ref asm_finalizar__MINIGAMES__CONECTOR;

                switch( nome_asm ){

                    case "asm_finalizar__MINIGAMES__CONECTOR": asm_ref = ref asm_finalizar__MINIGAMES__CONECTOR; break; 
