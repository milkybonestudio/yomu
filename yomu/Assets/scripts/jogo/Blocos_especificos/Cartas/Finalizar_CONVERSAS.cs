...
public static class Finalizador_CARTAS {
        ...
        public static Assembly asm_finalizar__CARTAS__CONECTOR;
        ...
        public static void Finalizar_especifico( string[] _finalizar_localizador ){   
                ...
                ref Assembly asm_ref = ref asm_finalizar__CARTAS__CONECTOR;

                switch( nome_asm ){

                    case "asm_finalizar__CARTAS__CONECTOR": asm_ref = ref asm_finalizar__CARTAS__CONECTOR; break; 
