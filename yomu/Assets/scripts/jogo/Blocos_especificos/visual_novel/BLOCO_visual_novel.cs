...
public class BLOCO_visual_novel {
       ...
       // um plot sempre tem que ser encerrado, VN nao pode iniciar outra VN
        ...
        public void Verificacao_passar_cena(){
            ...
            bool click_ir = Controlador_input.Get_down( Key_code.mouse_left ) || Controlador_input.Get_down( Key_code.space ) ;
            bool click_voltar = Input.GetMouseButtonDown( 1 ) || Controlador_input.Get_down( Key_code.esc ) ;

            bool pressionar_ir = Controlador_input.Get( Key_code.space );
            bool pressionar_voltar = Controlador_input.Get( Key_code.esc );
