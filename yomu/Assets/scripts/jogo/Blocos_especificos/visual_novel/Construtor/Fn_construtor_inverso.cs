...
public static class Fn_construtor_inverso {
    ...
    public static string CRIAR_mudar_cor_pergaminho_inverso( char _auto ){
                ...
                return new string(   
                    ...
                    new char[]{
                        ...
                        ( char ) (  ( int )  Controlador_tela_visual_novel.Pegar_instancia().pergaminho.cor_pergaminho_atual     + 48 )
    ...
    public static string CRIAR_transicao_final_inverso(){
        ...
        // if ( Controlador_tela_visual_novel.Pegar_instancia().vai_ser_escondido  ){
        //     // tem transicao
    ...
    public static string CRIAR_mudar_foco_camera_personagens_inverso( string _cena_texto , char _auto, Screen_play _screen_play ){
        ...
        int modo_id  = BLOCO_visual_novel.Pegar_instancia().screen_play.foco_camera_personagens_atual_id ;
        ...
        char instantaneo =  _cena_texto[ 4 ] ; // BLOCO_visual_novel.Pegar_instancia().screen_play.foco_camera_personagens_instantaneo;
    ...
    public static string CRIAR_mudar_background_inverso( string _cena_texto, char  _auto ,Screen_play _screen_play ){
        ...
        char foco = '2';  if( Controlador_tela_visual_novel.Pegar_instancia().Background_esta_em_foco() ) { foco = '3' ; }
    ...
    public static string CRIAR_abaixar_texto_inverso ( string _cena_texto , char _auto , Screen_play _screen_play ){
        ...
        bool esta_abaixado = Controlador_tela_visual_novel.Pegar_instancia().pergaminho.pergaminho_is_abaixado;
    ...
    public static string CRIAR_levantar_texto_inverso ( string _cena_texto , char _auto , Screen_play _screen_play ){
        ...
        bool esta_levantado = !Controlador_tela_visual_novel.Pegar_instancia().pergaminho.pergaminho_is_abaixado;
