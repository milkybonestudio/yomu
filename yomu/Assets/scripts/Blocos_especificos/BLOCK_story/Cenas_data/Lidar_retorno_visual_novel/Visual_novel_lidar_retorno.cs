                ...
                if( localizador.tipo != 0 )
                    {
                        ...
                        Action fn = ( Action ) CONTROLLER__data.instancia.modulo__leitor_dll_dados_blocos.Pegar_objeto( "Leitor_lidar_retorno_visual_novel", "Pegar",  new object[]{ ( object ) localizador });
                        if( fn == null )
