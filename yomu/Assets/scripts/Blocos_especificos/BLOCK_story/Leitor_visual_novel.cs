...
public class Leitor_visual_novel{
        ...
        public static Leitor_visual_novel Construir(){ 
            ...
            Leitor_visual_novel leitor = new Leitor_visual_novel(); 
                ...
                leitor.bloco_visual_novel = BLOCO_story.Pegar_instancia();
    ...
    public void Ler_fn ( string  _cena ){
        ...
        switch( nome_fn ){
            ...
            /// criar_coisas_tela
                ...
                case Nome_fn.encerrar_transicao: bloco_visual_novel.controlador_tela_story.Encerrar_transicao(); break;
