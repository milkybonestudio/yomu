      ...
      public static void Modificar_switch_MODO_personagens ( string _args ) {
            ...
            //  tipo  auto   nome_fn      'id'          'a'/'d'   
                  ...
                  switch( tipo_switch ){
                        ...
                        case Tipo_switch_MODO_fn.highlight: Debug.Log("veio highlight"); bloco_story.screen_play.is_highlight_activate = mod  ; break;


                        case Tipo_switch_MODO_fn.sombras: Debug.Log("veio sombra");bloco_story.screen_play.is_sombras_activate = mod;  break;

                        
                        case Tipo_switch_MODO_fn.tamanho:Debug.Log("veio tamanho"); bloco_story.screen_play.is_tamanho_activate = mod; break;
