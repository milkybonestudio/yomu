...
public static class TOOL__UI_button_SET_COMPLETE {
        ...
        public static void SET_ON_static( UI_button_COMPLETE botao ){
                ...
                UI_button_COMPLETE_visual_state estado = UI_button_COMPLETE_visual_state.on_estatico;
        ...
        public static void SET_OFF_static( UI_button_COMPLETE botao ){
                ...
                UI_button_COMPLETE_visual_state estado = UI_button_COMPLETE_visual_state.off_estatico;
                int pointer = 0; // Botao_dispositivo_SUPORTE.Pegar_pointer_inicial_estado( botao, estado  );
                     ...
                     if( botao.data.tipo_transicao == DEVICE_button_transition_type_OFF_ON.cor )
                        {
                            ...
                            botao.estado_visual_botao = UI_button_COMPLETE_visual_state.transicao_animacao_ON_para_OFF;
                     ...
                     if( botao.data.tipo_transicao == DEVICE_button_transition_type_OFF_ON.cor )
                        {
                            ...
                            botao.sprite_atual_index = -1;
                            botao.estado_visual_botao = UI_button_COMPLETE_visual_state.transicao_animacao_OFF_para_ON;
