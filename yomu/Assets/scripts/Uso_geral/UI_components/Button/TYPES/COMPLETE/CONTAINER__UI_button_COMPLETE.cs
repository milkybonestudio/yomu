...
public class CONTAINER__UI_button_COMPLETE : CONTAINER__generic {


        public CONTAINER__UI_button_COMPLETE (){

                type = typeof( UI_button_SIMPLE );
                Start( 300 );

        }

        public UI_button_COMPLETE Get_button(){ return ( UI_button_COMPLETE ) Get(); }
