...
public class CONTAINER__UI_button_SIMPLE : CONTAINER__generic {


        public CONTAINER__UI_button_SIMPLE (){
        ...
        public UI_button_SIMPLE Get_button(){  return ( UI_button_SIMPLE ) Get(); }
