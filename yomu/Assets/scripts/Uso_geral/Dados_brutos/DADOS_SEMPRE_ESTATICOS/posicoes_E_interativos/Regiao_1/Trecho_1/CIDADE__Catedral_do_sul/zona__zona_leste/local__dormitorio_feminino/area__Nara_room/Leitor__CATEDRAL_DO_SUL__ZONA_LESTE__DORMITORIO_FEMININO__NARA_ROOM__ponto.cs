...
*/
#if UNITY_EDITOR && ( REGIAO_1 || REGIAO_1__trecho_1 || REGIAO_1__CATEDRAL_DO_SUL || FORCAR_TUDO  ) || true



        public static class Leitor__CATEDRAL_DO_SUL__ZONA_LESTE__DORMITORIO_FEMININO__NARA_ROOM__ponto {
                ...
                public static Ponto_DADOS_DEVELOPMENT Pegar_ponto(  Posicao _posicao  ){
                    ...
                    if( dados[ ponto_id ] == null )
                        { throw new Exception( $" o ponto { ( CATEDRAL_DO_SUL__ZONA_LESTE__DORMITORIO_FEMININO__NARA_ROOM__ponto ) ponto_id } nao foi criado" ); }


                    return dados[ ponto_id ];
                ...
                public static void Colocar_pontos(){

                        dados = new Ponto_DADOS_DEVELOPMENT[ 100 ];
                        ...
                        // ------------------ 
                                ...
                                index = (int) CATEDRAL_DO_SUL__ZONA_LESTE__DORMITORIO_FEMININO__NARA_ROOM__ponto.up;

                        dados[ index ] = new Ponto_DADOS_DEVELOPMENT( index );

                        dados[ index ].imagem_principal_id = ( int ) CATEDRAL_DO_SUL__ZONA_LESTE__DORMITORIO_FEMININO__imagem.DEFAULT_ROOM;
                        dados[ index ].imagem_principal_nome = CATEDRAL_DO_SUL__ZONA_LESTE__DORMITORIO_FEMININO__imagem.DEFAULT_ROOM.ToString();
                        ...
                        try { 
                                ...
                                for( int ponto_dados_teste_index = 0 ; ponto_dados_teste_index< dados.Length ; ponto_dados_teste_index++ ){

                                        if( dados[ ponto_dados_teste_index ] == null )
                                            { continue; }
                                        
                                        dados[ ponto_dados_teste_index ].nome_ponto_DEVELOPMENT = (( CATEDRAL_DO_SUL__ZONA_LESTE__DORMITORIO_FEMININO__NARA_ROOM__ponto ) ponto_dados_teste_index ).ToString();
                                        dados[ ponto_dados_teste_index ].enum_nome_ponto_DEVELOPMENT = "CATEDRAL_DO_SUL__ZONA_LESTE__DORMITORIO_FEMININO__NARA_ROOM__ponto";

                                        Verificador_pontos_DEVELOPMENT.Checar_interativo_tela( dados[ ponto_dados_teste_index ] );
