...
public static class TOOL__get_data_audios_resources {
            ...
            // ** single
            public static byte[] Get_single_low_quality( RESOURCE__audio _image ){ 
            ...
            private static byte[] Get_single_low_quality_EDITOR( RESOURCE__audio _image ){
            ...
            private static byte[] Get_single_low_quality_BUILD( RESOURCE__audio _image ){
            ...
            public static byte[] Get_single( RESOURCE__audio _image ){ 
            ...
            private static byte[] Get_single_generico_EDITOR( RESOURCE__audio _image ){
            ...
            private static byte[] Get_single_generico_BUILD( RESOURCE__audio _image ){
            ...
            public static byte[] Get_multiples_low_quality(  RESOURCE__audio _image ){ return null;  }
            public static byte[] Get_multiples( RESOURCE__audio _image ){ return null; }

            public static byte[] Get_multiples_low_quality_EDITOR( RESOURCE__audio _image ){ return null; }
            public static byte[] Get_multiples_EDITOR( RESOURCE__audio _image ){ return null; }
