...
public static class TOOL__resources_images_sequences_handler_UP {


        public static int Handle_waiting_to_start( MANAGER__resources_images_sequences _manager, RESOURCE__image _image ){
                ...
                if( _image.multiples_images == null )
                    ...
                    { _manager.task_getting_compress_low_quality_file.fn_multithread = ( Task_req req ) => { TASK_REQ.Add_single_data( req, TOOL__get_data_images_resources.Get_multiples_data( _image.main_folder, ( _image.local_path + "_low_quality" ), _image.number_images ) ); }; } // --- MULTIPLES IMAGES
        ...
        public static int Handle_getting_compress_low_quality_file( MANAGER__resources_images_sequences _manager, RESOURCE__image _image ){
        ...
        public static int Handle_waiting_to_get_compress_file( MANAGER__resources_images_sequences _manager, RESOURCE__image _image ){
                ...
                if( _image.multiples_images == null )
                    ...
                    { _manager.task_getting_compress_file.fn_multithread = ( Task_req req )=> { TASK_REQ.Add_single_data( req, TOOL__get_data_images_resources.Get_multiples_data( _image.main_folder, ( _image.local_path ), _image.number_images ) ); }; } // --- MULTIPLES IMAGES
        ...
        public static int Handle_getting_compress_file( MANAGER__resources_images_sequences _manager, RESOURCE__image _image ){ 
        ...
        public static int Handle_waiting_to_get_texture( MANAGER__resources_images_sequences _manager, RESOURCE__image _image ){
        ...
        public static int Handle_getting_texture( MANAGER__resources_images_sequences _manager, RESOURCE__image image ){ 
                        
            throw new Exception( "nao era para usar" );
            
        }

        public static int Handle_waiting_to_pass_data_to_texture( MANAGER__resources_images_sequences _manager, RESOURCE__image _image ){
        ...
        public static int Handle_passing_data_to_texture( MANAGER__resources_images_sequences _manager, RESOURCE__image _image ){ 
        ...
        public static int Handle_waiting_to_apply_texture( MANAGER__resources_images_sequences _manager, RESOURCE__image _image ){
        ...
        public static int Handle_applying_texture( MANAGER__resources_images_sequences _manager, RESOURCE__image _image ){
        ...
        public static int Handle_waiting_to_create_sprite( MANAGER__resources_images_sequences _manager, RESOURCE__image _image ){
