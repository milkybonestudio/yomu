...
public class Controlador_pedidos_sistema {


        public static Controlador_pedidos_sistema instancia;
        public static Controlador_pedidos_sistema Pegar_instancia(){ return instancia; }
