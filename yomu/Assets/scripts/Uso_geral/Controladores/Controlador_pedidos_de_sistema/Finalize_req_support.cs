...
public static class Finalize_req_support {
    ...
    public static Pedido_para_finalizar Create_new_finalize_req(){
            ...
            Pedido_para_finalizar req = Controlador_pedidos_sistema.instancia.pedido_para_finalizar;
            ...
            Controlador_pedidos_sistema.instancia.pedido_para_finalizar = nova_Pedido_para_finalizar;
    ...
    public static Pedido_para_finalizar Get_finalize_req( bool _need_exist ){
        ...
        if( _need_exist && Controlador_pedidos_sistema.instancia.pedido_para_finalizar == null )
            { throw new Exception( "Tentou pegar uma copia do pointer transicao req, mas ela estava null" ); }

        return Controlador_pedidos_sistema.instancia.pedido_para_finalizar;
    ...
    public static Pedido_para_finalizar Take_finalize_req( bool _need_exist ){
            ...
            Pedido_para_finalizar retorno = Controlador_pedidos_sistema.instancia.pedido_para_finalizar; 
            Controlador_pedidos_sistema.instancia.pedido_para_finalizar = null;
