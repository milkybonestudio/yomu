...
*/
        ...
        public static class SAINT_LAND__CATEDRAL__DORMITORIO_FEMININO_interativos_lista {
                ...
                public static void Colocar_interativos(){
                        ...
                        interativos[ index ].cor_cursor_id = 0 ;
                        ...
                        interativos[ index ].tipo_sufixo_para_pegar_imagem =   Tipo_sufixo_para_pegar_imagem.dia_E_noite;
                        ...
                        interativos[ index ].cor_cursor_id = Cor_cursor.red;
                        ...
                        interativos[ index ].tipo_sufixo_para_pegar_imagem =   Tipo_sufixo_para_pegar_imagem.dia_E_noite ;
                        interativos[ index ].ponto_nome = Ponto_nome.UP_quarto_nara ;
                        interativos[ index ].cor_cursor_id = Cor_cursor.blue ;
                        ...
                        interativos[ index ].tipo_sufixo_para_pegar_imagem =   Tipo_sufixo_para_pegar_imagem.dia_E_noite;
                        interativos[ index ].ponto_nome = Ponto_nome.UP_quarto_nara;
                        interativos[ index ].cor_cursor_id = Cor_cursor.pink;
                        ...
                        interativos[ index ].tipo_sufixo_para_pegar_imagem =   Tipo_sufixo_para_pegar_imagem.nao_altera;
                        ...
                        */
                        ...
                        interativos[ index ].cor_cursor_id = Cor_cursor.green;
