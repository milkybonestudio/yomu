...
*/
        ...
        public static class SAINT_LAND__CATEDRAL__DORMITORIO_FEMININO__NARA_ROOM__pontos_LISTA_DADOS {
                ...
                public static Ponto_DADOS_DEVELOPMENT Pegar_interativo(  Posicao _posicao  ){
                    ...
                    if( dados[ ponto_id ] == null )
                        { throw new Exception( $" o ponto { ( SAINT_LAND__CATEDRAL__DORMITORIO_FEMININO__NARA_ROOM__ponto ) ponto_id } nao foi criado" ); }
                ...
                public static void Colocar_interativos(){
                        ...
                        // ------------------ 
                                ...
                                index = (int) SAINT_LAND__CATEDRAL__DORMITORIO_FEMININO__NARA_ROOM__ponto.up;
                        ...
                        try { 
                                ...
                                for( int ponto_dados_teste_index = 0 ; ponto_dados_teste_index< dados.Length ; ponto_dados_teste_index++ ){
                                        ...
                                        dados[ ponto_dados_teste_index ].nome_ponto_DEVELOPMENT = (( SAINT_LAND__CATEDRAL__DORMITORIO_FEMININO__NARA_ROOM__ponto ) ponto_dados_teste_index ).ToString();
                                        dados[ ponto_dados_teste_index ].enum_nome_ponto_DEVELOPMENT = "SAINT_LAND__CATEDRAL__DORMITORIO_FEMININO__NARA_ROOM__ponto";
