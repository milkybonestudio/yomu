...
*/
        ...
        public static class SAINT_LAND__CATEDRAL__DORMITORIO_FEMININO__interativos_lista {
                ...
                public static Interativo_tela Pegar_interativo(  Posicao_local _posicao_local,  int _interativo_id  ){
                    ...
                    if( ponto_id != interativos[ _interativo_id ].ponto_id )
                        { throw new Exception( $" O ponto_id estava diferente em SAINT_LAND__CATEDRAL__DORMITORIO_FEMININO__interativos_lista.Pegar(). O id que veio foi: { ponto_id } e oque tinha sido definido no interativo foi { interativos[ _interativo_id ].ponto_id } " ); }
                ...
                public static void Colocar_interativos(){
                        ...
                        interativos = new Interativo_tela[ 100 ];
                        ...
                        interativos[ index ].ponto_id = ( int ) SAINT_LAND__CATEDRAL__DORMITORIO_FEMININO__ponto.NARA_ROOM__up;
                        ...
                        try { 
                                ...
                                for( int interativo_teste_index = 0 ; interativo_teste_index< interativos.Length ; interativo_teste_index++ ){
                                        ...
                                        interativos[ interativo_teste_index ].nome_insterativo_DESENVOLVIMENTO = (( SAINT_LAND__CATEDRAL__DORMITORIO_FEMININO__interativo ) interativo_teste_index ).ToString();
                                        interativos[ interativo_teste_index ].enum_nome_interativo_DESENVOLVIMENTO = "SAINT_LAND__CATEDRAL__DORMITORIO_FEMININO__interativo";
                        ...
                        // interativos[ index ] = new Interativo_tela( index );
                        // interativos[ index ].tipo_interativo =  Tipo_interativo.cenas; // ativa espelho para ter a Tipo_interativo.movimento 
                        ...
                        // interativos[ index ] = new Interativo_tela( index );
                        // interativos[ index ].tipo_interativo =  Tipo_interativo.personagem;
                        
                        // interativos[ index ].conversa_nome = "teste";

                        // interativos[ index ].metodo_que_as_imagens_estao_salvas =   Metodo_que_as_imagens_estao_salvas.nao_altera;
                        ...
                        // interativos[ index ] = new Interativo_tela( index );
                        // interativos[ index ].tipo_interativo =  Tipo_interativo.utilidade;
                        ...
                        // interativos[ index ] = new Interativo_tela( index );
                        // interativos[ index ].tipo_interativo =  Tipo_interativo.cenas;
                        ...
                        // interativos[ index ].metodo_que_as_imagens_estao_salvas = Metodo_que_as_imagens_estao_salvas.dia_E_noite; // imagens por tempo

                        // // lily_comendo_biscoite__MANHA_1
                        
                        // interativos[ index ].tipo_mouse_hover = Interativo_tipo_mouse_hover.nada_E_nada;  // cores da imagem
                        ...
                        // interativos[ index ].cores_cursor = new Cor_cursor[]{
