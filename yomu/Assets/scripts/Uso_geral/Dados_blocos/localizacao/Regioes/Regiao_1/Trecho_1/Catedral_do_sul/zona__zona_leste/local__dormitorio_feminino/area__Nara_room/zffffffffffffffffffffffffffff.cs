...
//         public static class Leitor__SAINT_LAND__CATEDRAL__DORMITORIO_FEMININO__NARA_ROOM_interativos {
...
//                         { throw new Exception( $" o interativo { ( SAINT_LAND__CATEDRAL__DORMITORIO_FEMININO__NARA_ROOM__interativo ) _interativo_id } na nao foi criado" ); }

//                     if( ponto_id != dados[ _interativo_id ].ponto_id )
//                         { throw new Exception( $" O ponto_id estava diferente em Leitor__SAINT_LAND__CATEDRAL__DORMITORIO_FEMININO__NARA_ROOM_interativos.Pegar(). O id que veio foi: { ponto_id } e oque tinha sido definido no interativo foi { dados[ _interativo_id ].ponto_id } " ); }
...
//                                 index = (int) SAINT_LAND__CATEDRAL__DORMITORIO_FEMININO__NARA_ROOM__interativo.UP__bau;

//                         dados[ index ] = new Interativo_tela_DADOS_DESENVOLVIMENTO( index );
//                         dados[ index ].ponto_id = ( int ) SAINT_LAND__CATEDRAL__DORMITORIO_FEMININO__NARA_ROOM__ponto.corredor;
...
//                                 for( int interativo_dados_teste_index = 0 ; interativo_dados_teste_index< dados.Length ; interativo_dados_teste_index++ ){

//                                         if( dados[ interativo_dados_teste_index ] == null )
//                                             { continue; }
                                        
//                                         dados[ interativo_dados_teste_index ].nome_insterativo_DESENVOLVIMENTO = (( SAINT_LAND__CATEDRAL__DORMITORIO_FEMININO__DORMITORIO_FEMININO__interativo ) interativo_dados_teste_index ).ToString();
