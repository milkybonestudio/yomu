        ...
        public static class CATEDRAL_DO_SUL__ZONA_LESTE__DORMITORIO_FEMININO__NARA_ROOM__interativos_UP__LISTA_DADOS {
                ...
                public static Interativo_tela_DADOS_DESENVOLVIMENTO Pegar_interativo(  Posicao _posicao,  int _interativo_id  ){
                    ...
                    if( ponto_id != dados[ _interativo_id ].ponto_id )
                        { throw new Exception( $" O ponto_id estava diferente em CATEDRAL_DO_SUL__ZONA_LESTE__DORMITORIO_FEMININO__NARA_ROOM__interativos_UP__LISTA_DADOS.Pegar(). O id que veio foi: { ponto_id } e oque tinha sido definido no interativo foi { dados[ _interativo_id ].ponto_id } " ); }
                ...
                public static void Colocar_interativos(){
                        ...
                        try { 
                                ...
                                for( int interativo_dados_teste_index = 0 ; interativo_dados_teste_index< dados.Length ; interativo_dados_teste_index++ ){
                                        ...
                                        dados[ interativo_dados_teste_index ].nome_insterativo_DESENVOLVIMENTO = (( CATEDRAL_DO_SUL__ZONA_LESTE__DORMITORIO_FEMININO__NARA_ROOM__interativo ) interativo_dados_teste_index ).ToString();
                                        dados[ interativo_dados_teste_index ].enum_nome_interativo_DESENVOLVIMENTO = "CATEDRAL_DO_SUL__ZONA_LESTE__DORMITORIO_FEMININO__NARA_ROOM__interativo";
