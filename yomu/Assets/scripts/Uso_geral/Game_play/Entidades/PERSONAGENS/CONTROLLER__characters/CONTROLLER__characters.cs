...
unsafe public class CONTROLLER__characters : INTERFACE__controlador_entidade {
		...
		public void Load_entity( Locator_entidade[] _entidades ){ TOOL__loader_character.Load_entity_intern( this, _entidades ); } 
        public void Unload_entity( Locator_entidade[] _entidades ){ TOOL__unloader_character.Unload_entity_intern( this,  _entidades ); }
        public float Prepare_to_save_files(){ return TOOL__prepare_to_save_character.Prepare_to_save_files_intern( this ); }
        ...
        public Slot_entities slot_entidades_para_excluir; // vai guardar os ids


        // ** quando algum modificador for ativado ele vai salvar
        public File_to_save[] Pegar_dados_para_salvar(){ return null; } 
        ...
        // ** SORT
		public int[] characters_activated = new int[ 500 ];
