...
public interface INTERFACE__controlador_entidade {
        ...
        public void Load_entity( Locator_entity[] _localizadores ){ throw new System.Exception( $"nao foi implementado Carregar_entidades no controlador{ Pegar_nome() }" );}
        public void Unload_entity( Locator_entity[] _localizadores ){ throw new System.Exception( $"nao foi implementado Carregar_entidades no controlador{ Pegar_nome() }" );}
