...
public class Gerenciador_estado_mental {
        ...
        public Gerenciador_estado_mental( Character _personagem ){ personagem = _personagem; }
        ...
        public enum Tipo_funcao_salvar_geral : byte {

                modificar_personagem,
                
        }

        public enum Funcao_especifico_modificar_personagem : byte {
        ...
        unchecked {
                ...
                numero_bytes_necessarios += 2 ; // length para inserir
                ...
                int index = 0;
                instrucoes_de_seguranca[ index++ ] = ( byte )( Tipo_funcao_salvar_geral.modificar_personagem );
                
                instrucoes_de_seguranca[ index++ ] = ( byte ) (  ( int ) Funcao_especifico_modificar_personagem.modificar_estado_mental ) >> 8;
                ...
                //Controlador_personagens.Pegar_instancia().gerenciador_save.modulo_salvador.Colocar_instrucoes_de_seguranca( personagem_nome, ( byte )( Tipo_funcao_salvar_geral.modificar_personagem ), instrucoes_de_seguranca );
                ...
                byte[] container_buffer = null;//personagem.gerenciador_containers_dados.Pegar_buffer( Container_dados_personagem.dados_internos );
