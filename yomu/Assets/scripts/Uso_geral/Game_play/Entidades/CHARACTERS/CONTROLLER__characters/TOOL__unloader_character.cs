...
unsafe public static class TOOL__unloader_character {
        ...
        public static void Unload_entity_intern(  CONTROLLER__characters _controller, Locator_entity[] _entidades ){
            ...
            for( int character_slot_index = 0 ; character_slot_index < _entidades.Length ; character_slot_index++){ 
                    ...
                    _controller.data_manager.slot_entidades_para_excluir.Add_entity_id( locator.indentificador ); 
