using System;
    ...
    public static class Manipulador_arquivos {



        public static void Mudar_extensao_pasta( string _folder_para_mudar_as_extensoes, string _nova_extensao ){
                ...
                for( int folder_id = 0 ; folder_id < folders.Length ; folder_id++ ){
                        ...
                        Mudar_extensao_pasta( folder_path_para_mudar_as_extensoes , _nova_extensao );
