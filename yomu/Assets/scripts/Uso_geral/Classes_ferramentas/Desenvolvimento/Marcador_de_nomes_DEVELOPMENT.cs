...
public static class Marcador_de_nomes_DEVELOPMENT {
        ...
        public static void Colocar_nome_cartas( Type _tipo_interativo ,  string _nome_area, Carta_DADOS_DEVELOPMENT[] _dados  ){
                ...
                for( int interativo_dados_teste_index = 0 ; interativo_dados_teste_index< _dados.Length ; interativo_dados_teste_index++ ){
                        ...
                        Carta_DADOS_DEVELOPMENT interativo_dados = _dados[ interativo_dados_teste_index ];
                        ...
                        interativo_dados.nome_carta_DESENVOLVIMENTO = nome_insterativo_DESENVOLVIMENTO;
                        interativo_dados.enum_nome_carta_DESENVOLVIMENTO = _nome_area; //"CATEDRAL_DO_SUL__ZONA_LESTE__DORMITORIO_FEMININO__NARA_ROOM__UP";
