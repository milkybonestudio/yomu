                ...
                if( _interativo_tela.imagens_disponiveis_no_mouse_hover == Imagens_disponiveis_no_mouse_hover.nada_E_nada )
                        {
                                ...
                                if( _interativo_tela.metodo_das_cores_imagens_disponiveis_no_mouse_hover == Metodo_das_cores_imagens_disponiveis_no_mouse_hover.cores_especificas )
                                        { throw new Exception( $"No interativo { _interativo_tela.nome_insterativo_DESENVOLVIMENTO } a cor das imagens esta definida no metodo \"cores_especificas\" mas o Imagens_disponiveis_no_mouse_hover esta como nada_E_nada. Se nao tem imagem nao tem sentido terrem cores especificas" ); }
                            ...
                            if( _interativo_tela.metodo_das_cores_imagens_disponiveis_no_mouse_hover == Metodo_das_cores_imagens_disponiveis_no_mouse_hover.cores_especificas )
                                    { 
                                        if( _interativo_tela.cor_segunda_imagem == Nome_cor.nada )
                                            { throw new Exception( $"No interativo { _interativo_tela.nome_insterativo_DESENVOLVIMENTO } a cor das imagens esta definida no metodo \"cores_especificas\" e as imagens_disponiveis_no_mouse_hover como nada_E_one. Mas o a cor da segunda imagem não foi definida" ); }
                                            
                                        if( _interativo_tela.cor_primeira_imagem != Nome_cor.nada )
                                            { throw new Exception( $"No interativo { _interativo_tela.nome_insterativo_DESENVOLVIMENTO } a cor das imagens esta definida no metodo \"cores_especificas\" e as imagens_disponiveis_no_mouse_hover como nada_E_one. Mas o a cor da primeira imagem foi definida como { _interativo_tela.cor_primeira_imagem }. Nao pode ter nenhuma cor" ); }
                                        
                                    }

                            // se faz sentido 
                            if( _interativo_tela.metodo_das_cores_imagens_disponiveis_no_mouse_hover == Metodo_das_cores_imagens_disponiveis_no_mouse_hover.core_80_e_100 )
                                    { throw new Exception( $"No interativo { _interativo_tela.nome_insterativo_DESENVOLVIMENTO } a cor das imagens esta definida no metodo \"core_80_e_100\" mas o Imagens_disponiveis_no_mouse_hover esta como nada_E_one. nao tem como porque precisa de 2 imagens" ); }
                ...
                if( _interativo_tela.metodo_das_cores_imagens_disponiveis_no_mouse_hover == Metodo_das_cores_imagens_disponiveis_no_mouse_hover.cores_especificas )
                        ...
                        else if( _interativo_tela.metodo_das_cores_imagens_disponiveis_no_mouse_hover == Metodo_das_cores_imagens_disponiveis_no_mouse_hover.cor_especifica )
                        {
                                ...
                                if( _interativo_tela.cor_imagens == Nome_cor.nada )
                                        { throw new Exception( $"No interativo { _interativo_tela.nome_insterativo_DESENVOLVIMENTO } a cor das imagens esta definida no metodo \"cor_especifica\" mas a cor não foi definida" ); }
                                
                                if( _interativo_tela.cor_primeira_imagem != Nome_cor.nada )
                                        { throw new Exception( $"No interativo { _interativo_tela.nome_insterativo_DESENVOLVIMENTO } a cor das imagens esta definida no metodo \"cor_especifica\" mas a cor da imagem_1 foi definida como {_interativo_tela.cor_primeira_imagem}" ); }

                                if( _interativo_tela.cor_segunda_imagem != Nome_cor.nada )
                                        { throw new Exception( $"No interativo { _interativo_tela.nome_insterativo_DESENVOLVIMENTO } a cor das imagens esta definida no metodo \"cor_especifica\" mas a cor da imagem_2 foi definida como {_interativo_tela.cor_segunda_imagem}" ); }
