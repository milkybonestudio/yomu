...
public static class Manipulador_interativos {

        public static Controlador_navegacao controlador_navegacao;
        ...
        public static void Acrescentar_interativos( byte[][] _interativos_por_periodo, byte[][] _interativos_ids ){
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void Remover_interativos( byte[][] _interativos_por_periodo, byte[][] _interativos_ids ){
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static byte[][] Garantir_mesmo_formato_interativos( Ponto _ponto, Tipo_interativo_acao _tipo,  int _tipo_alocar_interativos ,byte[][] _interativos_ids ){

                
                // --- PEGA OS INTERATIVOS ATUAIS
                byte[][] interativos_local_ref = null;

                if( _tipo == Tipo_interativo_acao.adicionar )
                        {  interativos_local_ref = _ponto.interativos_por_periodo_para_adicionar_PONTOS[ ( byte ) _ponto.ponto_id ]; } // adicionar
                        else 
                        {  interativos_local_ref = _ponto.interativos_por_periodo_para_subtrair_PONTOS[ ( byte ) _ponto.ponto_id ]; } // subtrair
                ...
                if( metodo_tipo_alocar_atual != _tipo_alocar_interativos )
                        {
                                ...
                                if( metodo_tipo_alocar_atual > _tipo_alocar_interativos )
                                        ...
                                        if( _tipo == Tipo_interativo_acao.adicionar )
                                                { _ponto.interativos_por_periodo_para_adicionar_PONTOS[ ( byte ) _ponto.ponto_id ] = interativos_local_ref; } // adicionar
                                                else 
                                                { _ponto.interativos_por_periodo_para_subtrair_PONTOS[ ( byte ) _ponto.ponto_id ] = interativos_local_ref; } // subtrair
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static byte[][] REAJUSTAR__reduzir_interativos_para_DIA_E_NOITE( Posicao _posicao, byte[][] _interativos_por_periodo ){
