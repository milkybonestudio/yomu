...
using UnityEngine; 
        ...
        public static class Construtor_interativos_DEVELOPMENT {
                ...
                public static Interativo_tela Criar_interativo_tela_com_DADOS_DEVELOPMENT(  Interativo_tela_DADOS_DESENVOLVIMENTO _interativo_tela_dados ) {
                ...
                public static void Colocar_sprites_interativo_tela_DESENVOLVIMENTO(  Interativo_tela_DADOS_DESENVOLVIMENTO _interativo_dados , Interativo_tela _interativo ){
                        ...
                        for( int periodo_index = 0  ; periodo_index < periodos.Length ; periodo_index++  ){


                                Periodo_tempo periodo = periodos[ periodo_index ];
                                ...
                                if     ( _interativo_dados.metodo_IMAGENS_DISPONIVEIS_no_mouse_hover == Metodo_IMAGENS_DISPONIVEIS_no_mouse_hover.nada_E_nada )
                                        {
                                                ...
                                                _interativo.cores_imagem_1_ids_unicos_por_periodo[ periodo_index ] = ( int ) Nome_cor.transparente;
                                ...
                                if( path_imagem_1 != null  )
                                        {
                                                ...
                                                _interativo.sprites_imagem_1_ids_unicos_por_periodo[ periodo_index ] = pointer_imagem_atual;

                                                // nao importa se repetir a imagem 
                                                paths_imagens[ pointer_imagem_atual ] = path_imagem_1;
                                                pointer_imagem_atual++;
                                ...
                                if( path_imagem_2 != null  )
                                        {
                                                ...
                                                _interativo.sprites_imagem_2_ids_unicos_por_periodo[ periodo_index ] = pointer_imagem_atual;

                                                // nao importa se repetir a imagem 
                                                paths_imagens[ pointer_imagem_atual ] = path_imagem_2;
                                                pointer_imagem_atual++;
