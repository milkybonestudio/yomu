...
public class Gerenciador_containers_dinamicos_parciais {

        public Gerenciador_containers_dinamicos_parciais(  string _path_container, int _numero_inicial_de_slots  ){ 
