...
public class MODULO_manipulador_imagens_estaticas {


        // *** Vai sempre guardar o formato das imagens em png 
        // *** pode descomprimir para sprite 

        public MODULO_manipulador_imagens_estaticas( string _nome_modulo,  byte[] _localizador, string _path_container, int _numero_inicial_de_slots  ){
