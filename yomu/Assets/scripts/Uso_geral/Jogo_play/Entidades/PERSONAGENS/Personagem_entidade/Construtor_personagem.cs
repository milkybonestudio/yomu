...
public static class Construtor_personagem {
	    ...
	    public static  Personagem Construir(  int _personagem_id, int _plano_id, Dados_sistema_personagem_essenciais _dados_sistema_personagens_essenciais , byte[] _dados,  object _personagem_AI ){
		...
		public static Personagem Construir_personagem_teste( int _personagem_id, Atividade _atividade, Locator_position _posicao, byte[] _dados ){
