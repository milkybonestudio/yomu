...
//         public Dados_containers_plot Pegar_containers_plot_NAO_CARREGADO( int _plot_id ){

//                 string plots_nome = ( ( Plot_nome ) _plot_id ).ToString() ; // tem que trocar depois
//                 string path_dados = System.IO.Path.Combine( Paths_sistema.path_dados_save_plots, $"{ plot }" )   + "/" + plots_nome + "_dados.dat" ;
