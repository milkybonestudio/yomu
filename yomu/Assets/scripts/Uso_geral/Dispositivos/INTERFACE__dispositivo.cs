...
public interface INTERFACE__dispositivo {
        ...
        public string Get_main_folder(){ throw new System.Exception($"Na INTERFACE__dispositivo { Pegar_nome() } nao foi mudado o metodo Get_main_folder() mas ele foi chamado"); }
        ...
        public void Define_all_UI_components(){ throw new System.Exception( $"Na INTERFACE__dispositivo { Pegar_nome() } nao foi mudado o metodo Define_all_UI_components() mas ele foi chamado"); }
