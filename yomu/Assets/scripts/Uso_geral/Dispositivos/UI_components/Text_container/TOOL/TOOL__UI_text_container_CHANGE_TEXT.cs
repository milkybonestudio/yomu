...
public static class TOOL__UI_text_container_CHANGE_TEXT {
        ...
        public static void Force_complete( UI_text_container _container ){
            ...
            switch( _container.data.tipo_texto ){
                ...
                case Type_writing_construction.typewrite:  _container.simple_text.tmp_text.maxVisibleCharacters = _container.simple_text.tmp_text.textInfo.characterCount; break;
                case Type_writing_construction.fade:  _container.simple_text.tmp_text.ForceMeshUpdate(); break;
        ...
        public static void Build_instant( UI_text_container _container, string _pre_text , string _target_text ){
                ...
                _container.simple_text.tmp_text.color = _container.simple_text.tmp_text.color;
                _container.simple_text.tmp_text.text = ( _pre_text + _target_text );
                _container.simple_text.tmp_text.ForceMeshUpdate();
                _container.simple_text.tmp_text.maxVisibleCharacters = _container.simple_text.tmp_text.textInfo.characterCount;
                return;
        ...
        public static void Build_typewriter( UI_text_container _container, string _pre_text , string _target_text){
            ...
            _container.simple_text.tmp_text.color = _container.simple_text.tmp_text.color;
            _container.simple_text.tmp_text.maxVisibleCharacters = 0;
            _container.simple_text.tmp_text.text = _pre_text;
            ...
            _container.simple_text.tmp_text.text += _target_text;
            _container.simple_text.tmp_text.ForceMeshUpdate();
        ...
        public static UI_text_container_writing_state Update_typewriter( UI_text_container _container ){
                ...
                _container.simple_text.tmp_text.maxVisibleCharacters +=  _container.data.characters_per_cycle();

                if( ( _container.simple_text.tmp_text.maxVisibleCharacters >= _container.simple_text.tmp_text.textInfo.characterCount ) )
        ...
        public static void Build_fade( UI_text_container _container, string _pre_text , string _target_text ){
                ...
                Color text_color = _container.simple_text.tmp_text.color;
                ...
                if( _pre_text != "" )
                    {
                        _container.simple_text.tmp_text.ForceMeshUpdate();
                        pre_text_length = _container.simple_text.tmp_text.textInfo.characterCount;
                    }


                _container.simple_text.tmp_text.text += _target_text;

                _container.simple_text.tmp_text.maxVisibleCharacters = int.MaxValue;
                _container.simple_text.tmp_text.ForceMeshUpdate();

                
                TMP_TextInfo text_info = _container.simple_text.tmp_text.textInfo;
                ...
                _container.simple_text.tmp_text.UpdateVertexData( TMP_VertexDataUpdateFlags.Colors32 );
        ...
        public static UI_text_container_writing_state Update_fade( UI_text_container _container ){
                ...
                int variante_frame = ( int )( Time.deltaTime * _container.data.characters_per_cycle() * 255f ) + 1;
