...
public static class TOOL__UI_button_handler_COMPLEX {
        ...
        public static void Handle_off_animation( UI_button _button ){
        ...
        public static void Handle_on_animation( UI_button _button ){
        ...
        public static void Handle_transition_animation_OFF_to_ON( UI_button _button ){
                ...
                switch( _button.data.tipo_transicao ){
                    ...
                    case DEVICE_button_transition_type_OFF_ON.cor : TOOL__UI_button_TRANSITION_COMPLEX.Handle_transition_animation_OFF_to_ON_color( _button ); break;
                    case DEVICE_button_transition_type_OFF_ON.animacao_individual : TOOL__UI_button_TRANSITION_COMPLEX.Handle_transition_animation_OFF_to_ON_individual_animation( _button ); break;
        ...
        public static void Handle_transition_animation_ON_to_OFF( UI_button _button ){
            
                switch( _button.data.tipo_transicao ){

                    case DEVICE_button_transition_type_OFF_ON.nada : TOOL__UI_button_SET_COMPLEX.SET_OFF_static( _button ); break;
                    case DEVICE_button_transition_type_OFF_ON.cor : TOOL__UI_button_TRANSITION_COMPLEX.Handle_transition_animation_ON_to_OFF_color( _button ); break;
                    case DEVICE_button_transition_type_OFF_ON.animacao_individual : TOOL__UI_button_TRANSITION_COMPLEX.Lidar_transicao_animacao_ON_para_OFF_animacao_individual( _button ); break;
