        ...
        public static void Update_logica( UI_button _button ){
                ...
                if( _button.esta_houver )
                    ...
                    { 
                        ...
                        if( _button.activation_type == Botao_dispositivo_tipo_ativacao.entrar_no_botao )
                ...
                if( Input.GetMouseButtonDown( 0 ) )
                    { 
                        ...
                        if( _button.activation_type == Botao_dispositivo_tipo_ativacao.clicar )
                ...
                if( Input.GetMouseButtonUp( 0 ) && _button.esta_down )
                    { 
                        ...
                        if( _button.activation_type == Botao_dispositivo_tipo_ativacao.clicar_e_soltar && _button.esta_down )
                            { _button.Activate(); } // --- ATIVAR BOTAO
