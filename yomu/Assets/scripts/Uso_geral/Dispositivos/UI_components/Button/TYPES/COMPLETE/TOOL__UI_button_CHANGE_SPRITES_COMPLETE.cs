...
public static class TOOL__UI_button_CHANGE_SPRITES_COMPLETE {



        public static void Mudar_imagens_TRANSICAO(  UI_button_COMPLETE botao, int pointer ){
        ...
        public static void Change_images_IMAGE(  UI_button_COMPLETE botao, int pointer ){
