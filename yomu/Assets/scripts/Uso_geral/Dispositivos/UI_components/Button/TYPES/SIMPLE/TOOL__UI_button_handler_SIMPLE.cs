...
public static class TOOL__UI_button_handler_SIMPLE {
        ...
        public static void Handle_off_static( UI_button_SIMPLE _button ){
        ...
        // --- ON
        public static void Handle_on_static( UI_button_SIMPLE _button ){
        ...
        public static void Handle_transition_animation_OFF_to_ON( UI_button_SIMPLE _button ){
        ...
        public static void Lidar_transicao_animacao_ON_para_OFF( UI_button_SIMPLE _button ){
