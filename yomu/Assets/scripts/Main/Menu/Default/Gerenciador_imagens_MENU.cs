...
public static class Gerenciador_imagens_MENU {
        ...
        private static Sprite Pegar_sprite(  int _ponto_inicial , int _length  ){

                byte[] dados = desmembrador_de_arquivo.Pegar_dados(  _ponto_inicial, _length );
        ...
        public static  void Carregar_imagens( Dados_menu _dados ){
            ...
            //     int language_id = ( int ) CONTROLLER__configurations.Pegar_instancia().idioma;
