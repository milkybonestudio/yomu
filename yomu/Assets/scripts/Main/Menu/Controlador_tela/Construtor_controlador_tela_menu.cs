...
public static class Construtor_controlador_tela_menu {
    ...
    public static Controlador_tela_menu Construir( Dados_menu _dados_menu ){
        ...
        Controlador_tela_menu controlador_tela_menu = new Controlador_tela_menu();
            ...
            controlador_tela_menu.container_interativos_menu = new GameObject( "container_interativos_menu" );
            controlador_tela_menu.container_interativos_menu.transform.SetParent( controlador_tela_menu.canvas_menu_movel.transform, false );
            ...
            controlador_tela_menu.canvas_individuais_menu_objetos_estaticos = new GameObject[ numero_objetos_ativos ];
            controlador_tela_menu.canvas_individuais_menu_imagens_objetos_estaticos = new Image[ numero_objetos_ativos ];
            controlador_tela_menu.canvas_individuais_menu_rects_objetos_estaticos = new RectTransform[ numero_objetos_ativos ];
