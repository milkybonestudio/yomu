...
public static class Gerenciador_seguranca_main {
        ...
        public static IEnumerator C_reconstruindo_save (){
                ...
                while( CONTROLLER__main.Pegar_instancia().modo_controlador_atual == Controlador_modo.reconstruindo_save ){ yield return null; }
                yield break;
                ...
                if( !!!( arquivo_foi_encerrado_corretamente ) )
                    {
                            ...
                            CONTROLLER__main controlador = CONTROLLER__main.Pegar_instancia();
