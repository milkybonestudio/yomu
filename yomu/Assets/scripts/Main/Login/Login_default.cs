...
unsafe public class Login_default : PROGRAM_MODE {
        ...
        public override Transition Construct_transition( Transition_data _data ){
                ...
                Transition transition = new Transition(); // default constructor?
                
                // transition.Preparation = () => {};
                // transition.Up = ( Transition _t ) =>{ transition.Add_stage();};
                // transition.Mid = () =>{};
                // transition.Down = ( Transition _t ) =>{ transition.Add_stage(); };
                // transition.Mode_preparation = ( Transition _t ) =>{ transition.Add_stage(); };
                // transition.Mode_start = ( Transition _t ) =>{};

                // ** resources that need to be there
                transition.resource_container_minimun_checker.Add( image_login );

                transition.sections_actions.mode_start.NEW = () =>  {
