...
public static class Teste_cartas {
        ...
        public static void Criar( string _chave ){
                ...
                Jogo.Pegar_instancia().bloco_atual = Block_type.cartas;
                Jogo.Pegar_instancia().interfaces_blocos[ ( int ) Block_type.cartas ] =  Construtor_bloco_CARTAS.Construir( null ); // BLOCO_cartas.Iniciar_bloco_cartas();
