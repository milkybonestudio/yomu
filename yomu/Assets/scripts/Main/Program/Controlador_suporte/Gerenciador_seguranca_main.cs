...
public static class Gerenciador_seguranca_main {
        ...
        public static IEnumerator C_reconstruindo_save (){
                ...
                while( Program.Pegar_instancia().current_mode == Program_mode.reconstruindo_save ){ yield return null; }
                yield break;
                ...
                if( !!!( arquivo_foi_encerrado_corretamente ) )
                    {
                            ...
                            Program controlador = Program.Pegar_instancia();
                            ...
                            //                                                                 controlador.modes[ 0 ] = Login.Construct( null, null  ); //mark
                            //                                                                 return;
                            //                                                             };
                            
                            CONTROLLER__tasks.Pegar_instancia().Adicionar_task( task_reconstruir );
                            controlador.current_mode = Program_mode.reconstruindo_save;
