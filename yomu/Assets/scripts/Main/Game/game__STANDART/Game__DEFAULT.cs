...
unsafe public class Game__STANDART : PROGRAM_MODE {  
        ...
        public CONTROLLER__AI controller_AI;

        
        public override void Construct(){

            PROGRAM_DATA__game* data = &(Controllers_program.data.program_data->game);

                controller_AI = CONSTRUCTOR__controller_AI.Construct__STANDART();
