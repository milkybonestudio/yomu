...
public static class CONSTRUCTOR__menu {

        public static PROGRAM_MODE Construct(){
        ...
        //mark
        // ** isso tem que passar para o objeto menu
        public static void Instanciate( Dados_menu _dados_menu ){
