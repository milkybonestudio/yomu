...
unsafe public static class Test_stack__normal_behaviour {
    ...
    public static void Update(){
        ...
        if( Input.GetKeyDown( KeyCode.A ) )
            {
                Controllers.stack.files.Save_data_got_file_from_disk( '&', Path.Combine( Paths_program.saving_link_file_to_path )  );
