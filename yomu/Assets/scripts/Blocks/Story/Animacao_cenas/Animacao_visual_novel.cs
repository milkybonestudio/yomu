...
public static class Controlador_animacao_visual_novel{
    ...
    public static void Teste(){
        ...
        Transform pai = Controlador_tela_story.Pegar_instancia().animacao.transform;
        Image[] images = Controlador_tela_story.Pegar_instancia().Criar_frames( numero_quadros );
        ...
        Controlador_tela_story.Pegar_instancia().animacao_visual_novel = animacao_cenas_principal;
