...
// salvar em run time sem pausar o jogo vai aumentar muito a complexidade. ao invez de ter 2 stacks o jogo vai ter somente 1, quando a stack precisar ser esvaziada o jogo vai esperar o player dormir e então salvar. 
// o quanto vai demorar depende do tamanho do jogo, mas eu acho que mesmo com um jogo muito grande nao vai passar de 2 segundos. O jogo vai continuar salvando a todo momento, mas a passada para o disco vai ser em um momento especifico
...
public class Controlador_instrucoes_de_seguranca {
                ...
                public byte[][][] arquivos_instrucoes_personagens_completos = new byte[ 2 ][][]; // primeira + segunda stack
                ...
                public void Update( Modo_save _modo ){
                        ...
                        Controlador_personagens.Pegar_instancia().gerenciador_save.Pegar_instrucoes_de_seguranca_personagens( arquivos_instrucoes_personagens_completos, _modo );
