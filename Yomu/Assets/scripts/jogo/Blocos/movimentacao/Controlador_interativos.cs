...
public class Controlador_interativos {
    ...
    public Interativo[] interativos_arr ;
    ...
    public void  Iniciar(){
      ...
      //interativos_container = GameObject.Find("Tela/Canvas/Jogo/Interativos/Container");
      interativos_canvas = GameObject.Find("Tela/Canvas/Jogo/Interativos");
  ...
  */
    ...
    */ 
    ...
    public void Ativar_interativo(int _interativo_index){
            ...
            Script_jogo_nome script_interativo_em_espera = Lista_navegacao.Pegar_instancia().Pegar_script_interativo_em_espera(  interativo_nome  );
