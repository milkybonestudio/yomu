...
public static class Fn_methods{
      ...
      public static void Bloquear_voltar_cenas(){
            ...
            BLOCO_visual_novel.Pegar_instancia().screen_play.Aumentar_contador_cena();
            return;
      ...
      public static void Bloquear_passar_cenas( ){
            ...
            BLOCO_visual_novel.Pegar_instancia().screen_play.Diminuir_contador_cena();
            return;
...
*/                
            ...
            if( tipo == "cor" ){  
                  ...
                  if(  _modelo == "inicio" ){ Controlador_tela_visual_novel.Pegar_instancia().Transicao_cor_inicio( duracao_ms );  return ; }
                  if(  _modelo == "final" ){ Controlador_tela_visual_novel.Pegar_instancia().Transicao_cor_final( duracao_ms );  return ; }
      ...
      public static void Mudar_cor_pergaminho(string _args){
            ...
            Controlador_tela_visual_novel.Pegar_instancia().pergaminho.Mudar_cor_pergaminho( nome );
      ...
      public static void Mudar_cor_texto_personagens(string _args){
            ...
            string nome_display_atual = Controlador_tela_visual_novel.Pegar_instancia().pergaminho.Pegar_nome_atual();
            ...
            for(  int index = 0; index < numero_personagem ;index++ ){
                  ...
                  if( nome_display_atual == nome_display ){
                        ...
                        Controlador_tela_visual_novel.Pegar_instancia().pergaminho.Mudar_cor( nova_cor );
...
public static void Tremer_texto( string args  ){}
   ...
   public static void Mudar_posicao_pergaminho(string _args){
      ...
      public static void Criar_objeto ( string _args  ){
            ...
            //                   Controlador_tela_visual_novel.Pegar_instancia().Criar_objeto_simples( plano_string ,  obj_path , p_x , p_y  ) ;  
    ...
    public static void Mudar_background( string _args ){
            ...
            */
            ...
            if( novo_background_path != "0" ) { BLOCO_visual_novel.Pegar_instancia().screen_play.path_background_atual = novo_background_path; }

            switch( foco ){

                  case 0 :   if(Controlador_tela_visual_novel.Pegar_instancia().Background_esta_em_foco()){ foco = 3; } else { foco = 2; } break;
                  case 1 :   if(Controlador_tela_visual_novel.Pegar_instancia().Background_esta_em_foco()){ foco = 2; } else { foco = 3; } break;
                  case 2:    foco = 2 ; break;
                  case 3:    foco = 3 ; break;
            ...
            BLOCO_visual_novel.Pegar_instancia().screen_play.foco_camera_personagens_atual_id = foco;
            

            BLOCO_visual_novel.Pegar_instancia().screen_play.background_cor_id = cor;
   ...
   public static void Mudar_foco_camera_personagens( string _args ){
            ...
            BLOCO_visual_novel.Pegar_instancia().screen_play.foco_camera_personagens_atual_id = ( ( int ) modo_char  - 48 );
            BLOCO_visual_novel.Pegar_instancia().screen_play.foco_camera_personagens_instantaneo = args[ 4 ];
   ...
   public static  void Flip_foco(string args){
      ...
      public static void Modificar_switch_MODO_personagens ( string _args ) {
            ...
            //  tipo  auto   nome_fn      'id'          'a'/'d'   
                  ...
                  switch( tipo_switch ){
                        ...
                        case Tipo_switch_MODO_fn.highlight:  Controlador_personagens_visual_novel.Pegar_instancia().Tirar_highlight_todos_personagens( ) ;  bloco_visual_novel.screen_play.is_highlight_activate = mod  ; break;
                        case Tipo_switch_MODO_fn.sombras: bloco_visual_novel.screen_play.is_sombras_activate = mod;  break;
                        case Tipo_switch_MODO_fn.tamanho: bloco_visual_novel.screen_play.is_tamanho_activate = mod; break;
      ...
      public static void Mudar_nome_display ( string _args ){
            ...
            Pergaminho_modelo_1 pergaminho = Controlador_tela_visual_novel.Pegar_instancia().pergaminho;
