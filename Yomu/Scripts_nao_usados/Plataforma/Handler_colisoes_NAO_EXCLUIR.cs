...
//                 int numero_mobs = controlador_plataforma.mobs_in_world.Length;
//                 int numero_terreno = controlador_plataforma.terrenos_in_world.Length;
//                 int numero_projeteis = controlador_plataforma.projeteis_arr.Length;
...
//                                 objeto_foco_fisica = controlador_plataforma.controlador_player.player_atual.fisica ; 
//                                 objeto_foco_stats = controlador_plataforma.controlador_player.player_atual.stats;
                                
//                         } else

//                         if(i< 1 + numero_mobs){  

//                                 if(controlador_plataforma.mobs_in_world[i-1].stats.is_inativo) {continue;}
//                                 if(controlador_plataforma.mobs_in_world[i-1].stats.is_destruido) {continue;}

//                                 objeto_foco_fisica = controlador_plataforma.mobs_in_world[i-1].fisica;
//                                 objeto_foco_stats = controlador_plataforma.mobs_in_world[i-1].stats;
...
//                                 if(controlador_plataforma.terrenos_in_world[i-1-numero_mobs].stats.is_inativo) {continue;}
//                                 if(controlador_plataforma.terrenos_in_world[i-1-numero_mobs].stats.is_destruido) {continue;}
//                                 objeto_foco_fisica = controlador_plataforma.terrenos_in_world[i-1-numero_mobs].fisica ;
//                                 objeto_foco_stats = controlador_plataforma.terrenos_in_world[i-1-numero_mobs].stats;   
...
//                                 if(controlador_plataforma.projeteis_arr[i-1-numero_mobs - numero_terreno] == null) continue;

//                                 objeto_foco_fisica = controlador_plataforma.projeteis_arr[i-1-numero_mobs - numero_terreno].fisica;

//                                 objeto_foco_stats = controlador_plataforma.projeteis_arr[i-1-numero_mobs-numero_terreno].stats;    
...
//                                 if(controlador_plataforma.mobs_in_world[m_].stats.is_inativo) {continue;}
//                                 if(controlador_plataforma.mobs_in_world[m_].stats.is_destruido) {continue;}
                                
                                

                
//                                 if(   Mat.Verificar_colisao_retangulos( objeto_foco_fisica , controlador_plataforma.mobs_in_world[m_].fisica )   ) {
                                    
//                                         Verificar(objeto_foco_fisica,  objeto_foco_stats,  controlador_plataforma. mobs_in_world[m_].fisica  ,  controlador_plataforma.mobs_in_world[m_].stats);
...
//                                 if(controlador_plataforma.terrenos_in_world[t_].stats.is_inativo) {continue;}
//                                 if(controlador_plataforma.terrenos_in_world[t_].stats.is_destruido) {continue;}

                                

                        
//                                 if(   Mat.Verificar_colisao_retangulos( objeto_foco_fisica , controlador_plataforma.terrenos_in_world[t_].fisica )      ) {

                                        

//                                         Verificar(objeto_foco_fisica,  objeto_foco_stats,  controlador_plataforma.terrenos_in_world[t_].fisica  , controlador_plataforma.terrenos_in_world[t_].stats);
...
//                                 if(controlador_plataforma.projeteis_arr[p_] == null) continue;
                        
                            
//                                 if(   Mat.Verificar_colisao_retangulos( objeto_foco_fisica , controlador_plataforma.projeteis_arr[p_].fisica )      ) {

//                                         Verificar(objeto_foco_fisica,  objeto_foco_stats,  controlador_plataforma.projeteis_arr[p_].fisica  , controlador_plataforma.projeteis_arr[p_].stats);
...
//                 //                 if(   Mat.Verificar_colisao_retangulos( _fisica , controlador_plataforma.mobs_in_world[m_].fisica )   ) {Verificar(_fisica,  _stats,  controlador_plataforma. mobs_in_world[m_].fisica  ,  controlador_plataforma.mobs_in_world[m_].stats);}
...
//                 //                 if(   Mat.Verificar_colisao_retangulos( _fisica , controlador_plataforma.terrenos_in_world[t_].fisica )      ) {

//                 //                         Verificar(_fisica,  _stats,  controlador_plataforma.terrenos_in_world[t_].fisica  , controlador_plataforma.terrenos_in_world[t_].stats);
...
//                 //                 if(controlador_plataforma.projeteis_arr[p_] == null ||  _fisica.id == p_ ) continue;
                                        
//                 //                 if(   Mat.Verificar_colisao_retangulos( _fisica , controlador_plataforma.projeteis_arr[p_].fisica )      ) {

//                 //                         Verificar(_fisica,  _stats,  controlador_plataforma.projeteis_arr[p_].fisica  , controlador_plataforma.projeteis_arr[p_].stats);
...
//                 int ponto =   Mat.Calcular_ponto_entrada_retangulo( _movel_fisica , _fixo_fisica );
...
//                 float px_1 = controlador_plataforma.controlador_player.player_atual.fisica.position[0];
//                 float py_1 = controlador_plataforma.controlador_player.player_atual.fisica.position[1];
...
//                 for(int m = 0;  m < controlador_plataforma.mobs_in_world.Length  ;m++){



//                         if(controlador_plataforma.mobs_in_world[m].stats.is_destruido) continue;


//                         //   depois fazer um arr de bool para nao ir até o SetActive toda vez


//                         arr = controlador_plataforma.mobs_in_world[m].fisica.position;
//                         px_f = arr[0] - px_1;
//                         py_f = arr[1] - py_1;
                                                                
//                         if ( (px_f * px_f ) + (py_f * py_f)  < distancia_quadrado ) {

//                                 if(controlador_plataforma.mobs_in_world[m].stats.is_inativo) continue;
                                
//                                 controlador_plataforma.mobs_in_world[m].stats.is_inativo = false;

//                                 controlador_plataforma.mobs_in_world[m].mob_game_object.SetActive(true);

//                         } else {

//                                 if(!controlador_plataforma.mobs_in_world[m].stats.is_inativo) continue;

//                                 controlador_plataforma.mobs_in_world[m].stats.is_inativo = true;

//                                 controlador_plataforma.mobs_in_world[m].mob_game_object.SetActive(false);
...
//                 for(int t = 0;  t < controlador_plataforma.terrenos_in_world.Length  ;t++){


//                         if(controlador_plataforma.terrenos_in_world[t].stats.is_destruido) continue;

                        

//                         arr = controlador_plataforma.terrenos_in_world[t].fisica.position;
//                         px_f = arr[0] - px_1;
//                         py_f = arr[1] - py_1;
...
//                                    if(controlador_plataforma.terrenos_in_world[t].stats.is_inativo) continue;

//                                 controlador_plataforma.terrenos_in_world[t].stats.is_inativo = false;

                                

//                                 controlador_plataforma.terrenos_in_world[t].terreno_game_object.SetActive(true);
...
//                                 controlador_plataforma.terrenos_in_world[t].stats.is_inativo = true;

//                                 controlador_plataforma.terrenos_in_world[t].terreno_game_object.SetActive(false);
